...
type
  Tform8 = class(TForm)
    ...
    Zutatenliste: TLabel;
    imgbenutzeroberfläche: TImage;
    hglogout: TImage;
    btlogout: TImage;
    btnhinzufügen: TImage;
    lblZutat1: TLabel;
    btnpapprio: TImage;
    ...
    procedure btnhinzufügenClick(Sender: TObject);
...
begin
  if edtvar=1 then
    showMessage('Zutat hat schon oberste Priorität!');
  if edtvar=2 then
    begin
      merke:= lblzutat2.Text;

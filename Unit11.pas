...
procedure TForm11.btnzurückClick(Sender: TObject);
begin
  form9.show;         //eig noch variable einführen die sich merkt wo man zuletzt war --> siehe Unit9.pas var speicherunit
end;
